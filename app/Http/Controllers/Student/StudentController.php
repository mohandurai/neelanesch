...
class StudentController extends Controller
{
    ...
    public function studentlist()
    {
        ...
        $chaps = DB::select("SELECT A.id, A.user_id, A.first_name, A.last_name, A.gender, A.email, A.mobile, B.class as 'class_id', A.Section FROM `students` as A, student_class B WHERE A.class_id=B.id ORDER BY A.updated_date DESC");
