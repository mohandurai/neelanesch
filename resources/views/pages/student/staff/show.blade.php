...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ url('student/index') }}">Staff Master</a></li>
  ...
  <div class="col-md-12 grid-margin stretch-card"`>
    <div class="card">
      <div class="card-body">
        ...
        Staff Master &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" href="{{ url('/chapter')}}/{{$staffinfo->id}}/edit" role="button">Edit Staff {{$staffinfo->id}} - {{$staffinfo->name}}</a>
