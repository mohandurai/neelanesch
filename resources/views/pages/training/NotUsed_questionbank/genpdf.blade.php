  ...
  <div class="col-md-12 grid-margin stretch-card">
    ...
    @foreach($qntit as $kk => $qh)
      ...
      <form action="{{ url('questionbank/genpdf') }}" method="post" enctype="multipart/form-data">
          ...
          <label><h5>{{$romlet[$count]}}. {{$qh}}</h5></label>
          ...
          @foreach($qns[$kk] as $qq => $question)
            ...
            @elseif($kk == 7)
              ...
              <div class="form-group">
                ...
                <div class="form-check form-check-inline">
                    @if($question[1] != null)
                        <label class="form-check-label"> (1) &nbsp;&nbsp;&nbsp; {{$question[1]}} <br></label>
                    @endif
                    @if(isset($imgQuens[$tt][1]))
                    <br><br>(1) &nbsp;&nbsp;&nbsp; <img src="{{ url('storage/images/'.$tt .'/'. $imgQuens[$tt][1]) }}" height="100em" width="150em" alt="" title="" /><br>
                    @endif
                </div>
